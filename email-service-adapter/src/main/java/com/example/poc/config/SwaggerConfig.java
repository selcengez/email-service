...
// http://localhost:8001/email/api/v1/swagger-ui.html
@Configuration
@EnableSwagger2
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                ...
                .description("<b>Email API</b><br /><br />Updated: [" + (new Date(timestamp)).toString() + " ]"
                        + " <script>document.title = \"Email Service\";"
